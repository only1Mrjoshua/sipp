...
const CompanyLayout = () => {
  ...
  const navItems = [
    { icon: Briefcase, label: 'Internships', path: '/company/internships' },
    { icon: PlusCircle, label: 'Create Internship', path: '/company/create-internship' },
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          ...
          >
            ...
            <p className="text-text-secondary text-sm mb-6">
              Are you sure you want to logout of your company account? You will need to login again to access your dashboard.
            </p>
