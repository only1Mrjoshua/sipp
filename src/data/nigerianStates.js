...
export const NIGERIAN_STATES = {
  'Abia': [
    ...
    'Isiala Ngwa North', 'Isiala Ngwa South', 'Isuikwuato', 'Umuahia North',
    'Umuahia South', 'Ukwa East', 'Ukwa West', 'Ohafia', 'Osisioma',
    'Ngwa', 'Ugwunagbo'
  ],
  'Adamawa': [
  ...
  'Bauchi': [
    ...
    'Kirfi', 'Misau', 'Ningi', 'Shira', 'Tafawa Balewa', 'Toro', 'Warji',
    'Zaki'
  ],
  'Bayelsa': [
  ...
  'Cross River': [
    ...
    'Obanliku', 'Obubra', 'Obudu', 'Odukpani', 'Ogoja', 'Yakuur',
    'Yala'
  ],
  'Delta': [
  ...
  'Jigawa': [
    ...
    'Kurah', 'Maigatari', 'Malam Madori', 'Miga', 'Ringim', 'Roni',
  ...
  'Kebbi': [
    'Aleiro', 'Arewa Dandi', 'Argungu', 'Augie', 'Bagudo', 'Bayan Kudu',
    'Birnin Kebbi', 'Bunza', 'Dandi', 'Danko Wasagu', 'Fakai', 'Gwandu',
    'Jega', 'Kalgo', 'Koko/Besse', 'Maiyama', 'Ngaski', 'Sakaba',
  ...
  'Oyo': [
    ...
    'Oyo', 'Oyo East', 'Saki East', 'Saki West', 'Surulere'
  ],
  'Plateau': [
...
// Helper function: Get LGAs for a given state (case-insensitive)
export const getLGAsForState = (stateName) => {
  if (!stateName) return [];
  const normalized = stateName.trim().toLowerCase();
  for (const [key, value] of Object.entries(NIGERIAN_STATES)) {
...
// Helper function: Get all state names (sorted alphabetically)
