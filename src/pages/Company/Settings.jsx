  ...
  return (
    <Container className="py-8 max-w-3xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-text-secondary">Manage your company account settings</p>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          ...
          >
            ...
            <p className="text-text-secondary text-sm mb-6">
              Are you sure you want to delete your company account? This action is permanent and cannot be undone. 
              All your data, internship postings, and applications will be permanently removed.
            </p>
